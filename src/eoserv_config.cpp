...
{
	eoserv_config_default(config, "LogErr"             , "errors.log");
	eoserv_config_default(config, "LogOut"             , "output.log");
	...
	eoserv_config_default(config, "NPCsFile"           , "./data/npcs.ini");

	eoserv_config_default(config, "AchievementsFile"   , "./data/extras/achievements.ini");
	eoserv_config_default(config, "EOSbotFile"         , "./data/extras/eosbot.ini");
	eoserv_config_default(config, "DevilGateFile"      , "./data/extras/devilgate.ini");
	eoserv_config_default(config, "EventFile"          , "./data/extras/event.ini");
	eoserv_config_default(config, "MessageFile"        , "./data/extras/message.ini");
	eoserv_config_default(config, "PetsFile"           , "./data/extras/pets.ini");
	eoserv_config_default(config, "HarvestingFile"     , "./data/extras/harvesting.ini");
	eoserv_config_default(config, "ChatlogsFile"       , "./data/extras/chatlogs.ini");
	eoserv_config_default(config, "FishingFile"        , "./data/extras/fishing.ini");
	eoserv_config_default(config, "MiningFile"         , "./data/extras/mining.ini");
	eoserv_config_default(config, "CookingFile"        , "./data/extras/cooking.ini");
	eoserv_config_default(config, "CommandsFile"       , "./data/extras/commands.ini");
	eoserv_config_default(config, "EffectsFile"        , "./data/extras/effects.ini");
	eoserv_config_default(config, "MembersFile"        , "./data/extras/members.ini");
	eoserv_config_default(config, "WarpsFile"          , "./data/extras/warps.ini");
	eoserv_config_default(config, "Giftbox1File"       , "./data/extras/giftbox1.ini");
	eoserv_config_default(config, "Giftbox2File"       , "./data/extras/giftbox2.ini");
	eoserv_config_default(config, "ShavingFile"        , "./data/extras/shaving.ini");
	eoserv_config_default(config, "TileMessageFile"    , "./data/extras/tilemessage.ini");

	eoserv_config_default(config, "PartyMapsFile"      , "./data/testing/partymap.ini");

	eoserv_config_default(config, "CTFFile"            , "./data/extras/ctf.ini");
	eoserv_config_default(config, "BuffSpellsFile"     , "./data/extras/buffspells.ini");
	eoserv_config_default(config, "CurseFilterFile"    , "./data/extras/cursefilter.ini");
	eoserv_config_default(config, "BuffItemsFile"      , "./data/extras/buffitems.ini");
	eoserv_config_default(config, "CommandsFile"       , "./data/extras/commands.ini");
	eoserv_config_default(config, "EquipmentFile"      , "./data/extras/equipment.ini");
	eoserv_config_default(config, "PoisonFile"         , "./data/extras/poison.ini");

	eoserv_config_default(config, "SpellsFile"         , "./data/testing/spells.ini");
	eoserv_config_default(config, "PVPFile"            , "./data/testing/pvp.ini");

	eoserv_config_default(config, "MapDir"             , "./data/maps/");
	eoserv_config_default(config, "QuestDir"           , "./data/quests/");
	eoserv_config_default(config, "CommandDir"         , "./data/commands/");
	...
	eoserv_config_default(config, "PlayerPrefix"       , "#");
...
void eoserv_config_validate_admin(Config& config)
{
	...
	eoserv_config_default(config, "unban"         , 2);
	eoserv_config_default(config, "sunban"        , 3);
	...
	eoserv_config_default(config, "devil"         , 3);
	...
	eoserv_config_default(config, "global"        , 2);
	eoserv_config_default(config, "arena"         , 2);
	eoserv_config_default(config, "globalpk"      , 2);
	eoserv_config_default(config, "immune"        , 4);
	eoserv_config_default(config, "freeze"        , 3);
	eoserv_config_default(config, "unfreeze"      , 3);
	...
	eoserv_config_default(config, "ksoverride"    , 1);
