...
template <class EIF> struct EIF_Data_Base
{
	...
	hp(0), tp(0), mindam(0), maxdam(0), accuracy(0), evade(0), armor(0), unkb(0), str(0), intl(0), wis(0),
	...
	conreq(0), chareq(0), unkd(0), unke(0), weight(0), unkf(0), size(EIF::Size1x1) { }
...
template <class ENF> struct ENF_Data_Base
{
	...
	unka(0), hp(0), exp(0), mindam(0), maxdam(0), accuracy(0), evade(0), armor(0) { }
...
template <class ESF> struct ESF_Data_Base
{
	...
	ESF_Data_Base() : id(0), icon(0), graphic(0), tp(0), sp(0), cast_time(0), unka(0), unkb(0), unkc(0), type(ESF::Damage),
	target_restrict(ESF::NPCOnly), target(ESF::Normal), unkd(0), unke(0), unkf(0), mindam(0), maxdam(0), unkg(0), unkh(0),
	unki(0), unkj(0), accuracy(0), hp(0), unkk(0), unkl(0), unkm(0), unkn(0), unko(0), unkp(0), unkq(0), unkr(0) { }
