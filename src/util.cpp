...
namespace util
{
    std::string implode(std::string spacer, std::vector<std::string> vect, int startat)
    {
        std::string holder = "";

        for (std::size_t i = startat; i < vect.size(); ++i)
        {
            holder += vect[i];
    ...
    std::string implode(char cspacer, std::vector<std::string> vect, int startat)
    {
        std::string holder = "";
        std::string spacer = " ";
        spacer[0] = cspacer;
