...
/**
 * Combine a vector in to a string with a specified spacer
 */
std::string implode(char spacer, std::vector<std::string> vect, int startat = 0);

/**
 * Combine a vector in to a string with a specified spacer
 */
std::string implode(std::string spacer, std::vector<std::string> vect, int startat = 0);
