...
enum LawAction : unsigned char
{
    LAW_ACTION_MARRIAGE = 1,
    LAW_ACTION_DIVORCE = 2
};

enum LawReply : short
{
    LAW_ALREADY_MARRIED = 1,
    LAW_NOT_MARRIED = 2,
    LAW_FIANCE = 3,
    LAW_NO_GOLD = 4,
    LAW_INVALID_FIANCE = 5,
    LAW_BUSY = 6,
    LAW_DIVORCED = 7,
};
...
{
    PRIEST_CLOTHES = 1,
    PRIEST_UNEXPERIENCED = 2,
    PRIEST_PARTNER_MAP = 3,
    PRIEST_PARTNER_CLOTHES = 4,
    PRIEST_BUSY = 5,
    PRIEST_REQUEST = 6,
    PRIEST_PARTNER_ALREADY_MARRIED = 7,
    PRIEST_NO_PREMISSION = 8
};
